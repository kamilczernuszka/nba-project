...
// 'info' field
//--------------------------------------------------------------------
class Tornados_Customize_Info_Control extends WP_Customize_Control {
	public $type = 'info';
...
// 'hidden' field
//--------------------------------------------------------------------
class Tornados_Customize_Hidden_Control extends WP_Customize_Control {
	public $type = 'hidden';
	...
	public function render_content() {
		...
		if ( 'last_option' == $this->id && tornados_storage_get( 'need_footer_scripts', false ) ) {
			tornados_storage_set( 'need_footer_scripts', false );
...
// 'button' field
//--------------------------------------------------------------------
class Tornados_Customize_Button_Control extends WP_Customize_Control {
	public $type = 'button';
...
// 'switch' field
//--------------------------------------------------------------------
class Tornados_Customize_Switch_Control extends WP_Customize_Control {
	public $type = 'switch';
...
// 'icon' field
//--------------------------------------------------------------------
class Tornados_Customize_Icon_Control extends WP_Customize_Control {
	public $type = 'icon';
...
// 'checklist' field
//--------------------------------------------------------------------
class Tornados_Customize_Checklist_Control extends WP_Customize_Control {
...
// 'scheme_editor' field
//--------------------------------------------------------------------
class Tornados_Customize_Scheme_Editor_Control extends WP_Customize_Control {
			...
			/>
				...
				tornados_show_layout(
					tornados_show_custom_field(
						...
						$this->input_attrs,
						tornados_unserialize( $this->input_attrs['value'] )
					)
				);
				?>
			</span>
...
// 'text_editor' field
//--------------------------------------------------------------------
class Tornados_Customize_Text_Editor_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		tornados_storage_set( 'need_footer_scripts', true );
	}
}
...
// 'range' field
//--------------------------------------------------------------------
class Tornados_Customize_Range_Control extends WP_Customize_Control {
	public $type = 'range';
	...
	public function render_content() {
		...
		<div class="customize-control-wrap">
			...
			<span class="customize-control-field-wrap"><input type="<?php echo ! $show_value ? 'hidden' : 'text'; ?>" 
				...
				$this->link();
				if ( $show_value ) {
					echo ' class="tornados_range_slider_value"';
				}
				if ( ! empty( $this->input_attrs['var_name'] ) ) {
					echo ' data-var_name="' . esc_attr( $this->input_attrs['var_name'] ) . '"';
				}
