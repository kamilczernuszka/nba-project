...
Please install and activate it before starting to use the theme Tornados.
...
Theme documentation is available on http://tornados.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Tornados is Fontello.
