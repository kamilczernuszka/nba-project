		...
		<div class="sc_events_item_header">
			...
			<div class="sc_events_item_meta">
				<span class="sc_events_item_meta_item sc_events_item_meta_date">
                    <span class="label_event"><?php esc_html_e('Time: ', 'tornados'); ?></span><?php
					if ($dt == $dt2) {
						if ( $tm == null ) {
                ...
                ?>
                <span class="sc_events_item_meta_item sc_events_item_price"><span class="label_event"><?php echo esc_html__('Cost: ', 'tornados').'</span>'. esc_html(!empty($cost) ? $cost : esc_html__('free', 'tornados')); ?></span>
			</div>
