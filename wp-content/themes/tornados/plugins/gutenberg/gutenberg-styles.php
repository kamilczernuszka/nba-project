...
if ( ! function_exists( 'tornados_gutenberg_add_theme_vars' ) ) {
	add_filter( 'tornados_filter_add_theme_vars', 'tornados_gutenberg_add_theme_vars', 10, 2 );
	function tornados_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'tornados_gutenberg_get_css' ) ) {
	add_filter( 'tornados_filter_get_css', 'tornados_gutenberg_get_css', 10, 2 );
	function tornados_gutenberg_get_css( $css, $args ) {
