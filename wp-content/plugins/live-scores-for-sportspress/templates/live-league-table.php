...
$output .= '<th class="data-rank">' . __( 'Pos', 'live-scores-for-sportspress' ) . '</th>';
...
if ( $show_full_table_link )
	$output .= '<div class="sp-league-table-link sp-view-all-link"><a href="' . get_permalink( $id ) . '">' . __( 'View full table', 'live-scores-for-sportspress' ) . '</a></div>';
?>
<div data-lsfs-live-table="<?php echo esc_attr( $id ); ?>" data-lsfs-live-table-link-teams="<?php echo esc_attr( $link_posts ); ?>" data-lsfs-live-table-logo="<?php echo esc_attr( $show_team_logo ); ?>" data-lsfs-live-table-columns="<?php echo esc_attr( implode( ',', $columns ) ); ?>" class="sp-template sp-template-league-table">
	<?php echo $output; ?>
</div> 
